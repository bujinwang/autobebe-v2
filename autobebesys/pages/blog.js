...
export default function Blog() {
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>Blog | AutoBebeSys</title>
        <meta name="description" content="Latest insights and news about healthcare technology and medical practice management" />
      </Head>
...
export async function getStaticProps() {
  ...
  return {
    props: {
      // You could pass the blog posts here
    },
  };
}
